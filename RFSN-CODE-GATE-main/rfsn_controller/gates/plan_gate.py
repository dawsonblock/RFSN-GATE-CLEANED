...
class PlanGate:
    ...
    def register_step_type(self, step_type: str) -> None:
        """Register a new allowed step type.
        
        This should only be called during initialization, not at runtime.
        Learning systems CANNOT call this method.
